 ...
 * 根插串算子
 */
public class AdaGepRootInsertSequenceOperator extends MutationOperator
{
	private AdaGep gep;
	private int[] lengthes;			// 串的长度可选值
	
	public AdaGepRootInsertSequenceOperator(AdaGep gep, double probability, int[] lengthes)
	{
		super(probability);
		this.gep = gep;
