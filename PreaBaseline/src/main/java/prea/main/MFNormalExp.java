...
public class MFNormalExp {
    ...
    protected final static String[] rootDirs  = { "C:/netflix/1/", "C:/netflix/2/", "C:/netflix/3/",
                                                  "C:/netflix/4/", "C:/netflix/5/" };
    ...
    public static void doNMF(String train, String test, int featureCount) {
        ...
        LoggerUtil.info(logger,
            "Train: " + train + "\tTest: " + test + "\n" + String.format("%.4f", metric.getRMSE())
                                + "\t" + String.format("%.4f", metric.getNDCG2()) + "\t"
                                + String.format("%.4f", metric.getAveragePrecision()));
    ...
    public static void doPMF(String train, String test, int featureCount) {
        ...
        PMF baseline = new PMF(userCount, itemCount, maxValue, minValue, featureCount, 50, 0.4, 0.8,
            maxIter, true);
        baseline.buildModel(rateMatrix);
        rateMatrix.clear();
        System.gc();
